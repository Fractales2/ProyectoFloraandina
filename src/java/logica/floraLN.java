...
public class floraLN {
    public static void insertarFlora(Flora flora, int usuario, int familia, int reserva) {
       
        boolean resp = false;
        ArrayList<Parametro> lstpar = new ArrayList<>();
        lstpar.add(new Parametro(1,usuario));
        lstpar.add(new Parametro(2,familia));
        ...
        lstpar.add(new Parametro(9,reserva));
        
        
        String sql = "INSERT INTO public.\"FLORA\"(\n" +
"	\"Id_User\", \"Id_Familia\", \"Nombre_Flora\", \"UbicacionX\", \"UbicacionY\", \"Cod_Herbario\", \"Nombre_Investigador\", \"Recoleccion\", \"Id_Reserva\")\n" +
"	VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);";            
